...
function Rc() {
  ...
  function Xe(f, v, M) {
    var F,
      ...
      Z = null;
    if (v != null)
      for (F in (v.ref !== void 0 && (Z = v.ref),
      v.key !== void 0 && (H = "" + v.key),
      v))
        nn.call(v, F) && !Me.hasOwnProperty(F) && (B[F] = v[F]);
    ...
    if (f && f.defaultProps)
      for (F in ((Y = f.defaultProps), Y)) B[F] === void 0 && (B[F] = Y[F]);
    return {
      $$typeof: P,
      type: f,
      key: H,
  ...
  function tn(f, v, M, F, B) {
    ...
    if (Z)
      return (
        ...
        Ce(B)
          ? ((M = ""),
            f != null && (M = f.replace(cn, "$&/") + "/"),
            tn(B, v, M, "", function (He) {
              return He;
            }))
          : B != null &&
            (gn(B) &&
    ...
    else if (((te = G(f)), typeof te == "function"))
      for (f = te.call(f), Y = 0; !(H = f.next()).done; )
        (H = H.value), (te = F + Be(H, Y++)), (Z += tn(H, v, M, te, B));
    else if (H === "object")
      throw (
        ((v = String(f)),
        Error(
        ...
        v.then(
          function (M) {
            (f._status === 0 || f._status === -1) &&
              ((f._status = 1), (f._result = M));
          },
          function (M) {
            (f._status === 0 || f._status === -1) &&
              ((f._status = 2), (f._result = M));
          },
        ),
  ...
  return (
    ...
    (I.cloneElement = function (f, v, M) {
      ...
      if (v != null) {
        if (
          (v.ref !== void 0 && ((H = v.ref), (Z = ze.current)),
        ...
        for (te in v)
          nn.call(v, te) &&
            ...
            (F[te] = v[te] === void 0 && Y !== void 0 ? Y[te] : v[te]);
      }
      ...
      return { $$typeof: P, type: f.type, key: B, ref: H, props: F, _owner: Z };
    }),
    ...
    (I.isValidElement = gn),
    (I.lazy = function (f) {
      return { $$typeof: pe, _payload: { _status: -1, _result: f }, _init: je };
    }),
    (I.memo = function (f, v) {
    ...
    (I.useDeferredValue = function (f) {
      return oe.current.useDeferredValue(f);
    }),
    (I.useEffect = function (f, v) {
      return oe.current.useEffect(f, v);
    }),
    (I.useId = function () {
      return oe.current.useId();
    }),
    (I.useImperativeHandle = function (f, v, M) {
      return oe.current.useImperativeHandle(f, v, M);
    }),
    (I.useInsertionEffect = function (f, v) {
      return oe.current.useInsertionEffect(f, v);
    }),
    (I.useLayoutEffect = function (f, v) {
      return oe.current.useLayoutEffect(f, v);
    }),
    (I.useMemo = function (f, v) {
      return oe.current.useMemo(f, v);
    }),
    (I.useReducer = function (f, v, M) {
      return oe.current.useReducer(f, v, M);
    }),
    (I.useRef = function (f) {
    ...
    (I.useSyncExternalStore = function (f, v, M) {
      return oe.current.useSyncExternalStore(f, v, M);
    }),
    ...
    za ||
      ...
      (function (P) {
        ...
        function ve(k) {
          ...
          if (C !== R) {
            k[0] = C;
            e: for (var f = 0, v = k.length, M = v >>> 1; f < M; ) {
              var F = 2 * (f + 1) - 1,
                B = k[F],
                H = F + 1,
                Z = k[H];
              if (0 > V(B, C))
                H < v && 0 > V(Z, B)
                  ? ((k[f] = Z), (k[H] = C), (f = H))
                  : ((k[f] = B), (k[F] = C), (f = F));
              else if (H < v && 0 > V(Z, C)) (k[f] = Z), (k[H] = C), (f = H);
              else break e;
            }
          }
          return R;
        ...
        function Ye(k) {
          for (var R = m(ye); R !== null; ) {
            if (R.callback === null) ve(ye);
              ...
              ve(ye), (R.sortIndex = R.expirationTime), j(K, R);
            else break;
            R = m(ye);
          }
        }
        ...
        function nn(k, R) {
          ...
          try {
            ...
            if (b !== null) var M = !0;
              ...
              var F = m(ye);
              F !== null && oe(Ce, F.startTime - R), (M = !1);
            }
            return M;
          } finally {
            (b = null), (G = C), (Re = !1);
          ...
          (P.unstable_scheduleCallback = function (k, R, C) {
            ...
            return (
              ...
              C > f
                ...
                : ((k.sortIndex = v), j(K, k), Oe || Re || ((Oe = !0), je(nn))),
              k
            );
          }),
...
var La;
function Dc() {
  return La || ((La = 1), (Ni.exports = jc())), Ni.exports;
}
/**
 * @license React
...
` + l[i].replace(" at new ", " at ");
  ...
  function Ua(e, n, t, r, l, u, i, o, s) {
    (Ft = !1), (Sr = null), Ia.apply(Fa, arguments);
  }
  ...
  var Zi = j.unstable_scheduleCallback,
    Ji = j.unstable_cancelCallback,
    Ba = j.unstable_shouldYield,
    Ha = j.unstable_requestPaint,
    ae = j.unstable_now,
    $a = j.unstable_getCurrentPriorityLevel,
    $l = j.unstable_ImmediatePriority,
    qi = j.unstable_UserBlockingPriority,
    Cr = j.unstable_NormalPriority,
    Wa = j.unstable_LowPriority,
    bi = j.unstable_IdlePriority,
    xr = null,
    pn = null;
  function Qa(e) {
  ...
  function $t(e, n) {
    e.blockedOn === n &&
      ...
      Xl ||
        ((Xl = !0),
        j.unstable_scheduleCallback(j.unstable_NormalPriority, ef)));
  }
  function Wt(e) {
    function n(l) {
      return $t(l, e);
  ...
  var ln = typeof Object.is == "function" ? Object.is : Ff;
  function Zt(e, n) {
    if (ln(e, n)) return !0;
    if (
      typeof e != "object" ||
...
`,
  ...
  function Ko(e, n, t) {
    if (xe.current !== In) throw Error(m(168));
    J(xe, n), J(De, t);
  }
  function Yo(e, n, t) {
    var r = e.stateNode;
  ...
  function Fn() {
    if (!Su && kn !== null) {
      ...
      try {
        ...
        throw (kn !== null && (kn = kn.slice(e + 1)), Zi($l, Fn), l);
      } finally {
        (X = n), (Su = !1);
      }
    }
        ...
        return (
          (n =
            n.nodeType !== 1 || t.toLowerCase() !== n.nodeName.toLowerCase()
              ...
              : n),
          n !== null
            ? ((e.stateNode = n), (We = e), (Qe = jn(n.firstChild)), !0)
            : !1
        );
      case 6:
        return (
  ...
  function Gr(e) {
    ...
    } else Qe = We ? jn(e.stateNode.nextSibling) : null;
    return !0;
  }
  function es() {
  ...
  function Mu(e, n) {
    switch ((J(ir, n), J(ur, e), J(hn, lr), (e = n.nodeType), e)) {
      case 9:
      case 11:
  ...
  function Ku(e, n, t, r) {
    ...
    typeof u == "object" && u !== null
      ? (l.context = Je(u))
      : ((u = Ie(n) ? Zn : xe.current), (l.context = wt(e, u))),
...
` +
  ...
  function Xs(e, n, t) {
    ...
    if ((J(ue, r), !(n.mode & 1))) n.memoizedState = null;
    else
      switch (l) {
        case "forwards":
      ...
      case 13:
        if (((r = n.memoizedState), r !== null))
          return r.dehydrated !== null
            ? (J(ue, ue.current & 1), (n.flags |= 128), null)
                ...
                if (((i = nl(e)), i !== null)) {
                  for (
                    ...
                    (u = t),
                      ...
                      (t = t.sibling);
                  return J(ue, (ue.current & 1) | 2), n.child;
                }
                e = e.sibling;
              }
            u.tail !== null &&
  ...
  function fn(e, n, t, r) {
    ...
    At(e, t, r),
      (!(A & 2) || e !== we) &&
        ...
        Ae(e, r),
        t === 1 && A === 0 && !(n.mode & 1) && ((Tt = ae() + 500), Kr && Fn()));
  }
  function Ae(e, n) {
  ...
  function rt(e) {
    ...
    try {
      ...
      (X = r), (be.transition = t), (A = n), !(A & 6) && Fn();
    }
  }
  function mi() {
    (Ke = Lt.current), ne(Lt);
    ...
    if (Hn !== null) {
      ...
      try {
        if (((be.transition = null), (X = 16 > e ? 16 : e), Hn === null))
          ...
          if (
            ((A = l), Fn(), pn && typeof pn.onPostCommitFiberRoot == "function")
          )
            try {
  ...
  ya = function (e, n, t) {
    if (e !== null)
      if (e.memoizedProps !== n.pendingProps || De.current) Fe = !0;
        ...
        if (!(e.lanes & t) && !(n.flags & 128)) return (Fe = !1), sc(e, n, t);
        Fe = !!(e.flags & 131072);
      }
    else (Fe = !1), re && n.flags & 1048576 && Zo(n, Xr, n.index);
    ...
    switch (e.tag) {
      case 3:
        ...
        if (n.current.memoizedState.isDehydrated) {
          ...
          t !== 0 &&
            (Kl(n, t | 1), Ae(n, ae()), !(A & 6) && ((Tt = ae() + 500), Fn()));
        }
        break;
      case 13:
        rt(function () {
...
function Fc() {
  ...
  return P(), (_i.exports = Ic()), _i.exports;
}
var Oa;
function Uc() {
  if (Oa) return zl;
...
function Bc() {
  const [P, j] = Ll.useState("0"),
    ...
    le = (z) => {
      const D = P,
        U = [...m];
      (U.length === 0 || Ma.includes(U[U.length - 1])) && U.push(D),
        U.length > 0 && Ma.includes(U[U.length - 1])
          ? (U[U.length - 1] = z)
          : U.push(z),
        ve(U),
        W(!0);
...
function Hc() {
  return q.jsx("div", { children: q.jsx(Bc, {}) });
}
Ac.createRoot(document.getElementById("root")).render(
  q.jsx(Ll.StrictMode, { children: q.jsx(Hc, {}) }),
);
